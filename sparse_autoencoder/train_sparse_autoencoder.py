...
Input
    ->
Linear(74 -> 64) -> Sigmoid   (encoder activation a1, sparsity applied)
    ->
...
Linear(32 -> 64) -> ReLU
    ->
Linear(64 -> 74) -> Sigmoid   (output in the same 0..1 range as inputs)
    ->
Output
"""
...
# A small value such as rho = 0.05 means we want each unit to stay mostly inactive.
